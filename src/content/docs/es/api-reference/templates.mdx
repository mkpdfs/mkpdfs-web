...
Las plantillas son archivos Handlebars (`.hbs`) que mkpdfs compila con tus datos en el momento de generar el PDF. Todos los endpoints de plantillas están bajo `/v1/templates` y requieren una clave de API. Consulta [Autenticación](/docs/api-reference/authentication).
