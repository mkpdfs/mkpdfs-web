...
Ten en cuenta que `Authorization: Bearer <token>` es rechazado explícitamente en los endpoints `/v1/*`. Consulta [Autenticación](/es/docs/api-reference/authentication) para más detalles.
...
- [Plantillas](/es/docs/api-reference/templates)
