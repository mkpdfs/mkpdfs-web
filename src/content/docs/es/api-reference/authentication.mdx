...
Para rotar una clave, crea una nueva en el panel o con `mkp tokens create`, actualiza tus variables de entorno y luego elimina la clave antigua desde el panel o con `mkp tokens delete <token-id>`. Las claves desactivadas en el panel son rechazadas de inmediato por la API.
