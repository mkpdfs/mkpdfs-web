...
Usa cualquier plantilla del mercado o [sube la tuya propia](/docs/api-reference/templates). Para este inicio rápido, reemplaza el ID de plantilla con uno real de tu panel de control.
...
- [Referencia de API — Generar PDF](/docs/api-reference/generate-pdf) para la especificación completa del endpoint y los códigos de error.
- [Plantillas](/docs/api-reference/templates) para aprender a subir y administrar tus propias plantillas Handlebars.
- [Instalar el CLI](/docs/getting-started/cli-install) para administrar todo desde tu terminal.
