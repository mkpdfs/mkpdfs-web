...
Empieza con [Inicio rápido](/docs/getting-started/quickstart) si quieres generar tu primer PDF en los próximos dos minutos, o ve directamente a la [Referencia de API](/docs/api-reference/generate-pdf) si ya sabes lo que necesitas.
